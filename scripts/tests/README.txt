...
JsTestDriver IntelliJ plugin
    http://confluence.jetbrains.com/display/WI/JsTestDriver+IntelliJ+plugin
    http://confluence.jetbrains.com/display/WI/Getting+Started+with+JsTestDriver+IntelliJ+plugin

======

Code Coverage
    http://blog.jetbrains.com/webide/2012/04/javascript-unit-testing-with-code-coverage/
